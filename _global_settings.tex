...
\newcommand{\fsO}{\textit{Fabric\#-O}\xspace}
\newcommand{\fsF}{\textit{Fabric\#-F}\xspace}
\newcommand{\fsP}{\textit{Fabric\#-P}\xspace}
\newcommand{\fsL}{\textit{Fabric\#-L}\xspace}
\newcommand{\fsS}{\textit{Fabric\#-S}\xspace}

\newcommand{\ff}{\textit{FastFabric}\xspace}
% \newcommand{\ffs}{\textit{FastFabricSharp}\xspace}
\newcommand{\fabricPlusplus}{\textit{Fabric++}}
\newcommand{\fsPrO}{\textit{FabricProv-O}}
\newcommand{\fsPr}{\textit{FabricProv}}
\newcommand{\fsPrF}{\textit{FabricProv-F}}
...
\newcommand{\tid}[1]{{tid\/}_{#1}}
\newcommand{\privk}[1]{PrivK_{#1}}
\newcommand{\pubk}[1]{PubK_{#1}}
\newcommand{\enc}{enc\/}
\newcommand{\dec}{dec\/}
