...
As an attempt to databasify blockchains, we not only demonstrate the vast possibilities but also appeal to more system researchers on this promising area. 
