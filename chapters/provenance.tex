...
The second one, which we refer as {\fsPlus}, directly enhances the original storage engine LevelDB for the provenance. 
...
Despite the storage differences, {\fsPlus} is similar with {\fs}, i.e., both share the exact provenance capturer and query handlers. 
...
In the last one, we place a specific analysis on the provenance query and space consumption of the storage engine. 
Only in this experiment we involve {\fsLite}, which strips away DASL out of {\fs} but still employs ForkBase.

\subsection{Peak Performance}
\subsection{Provenance Utility and Overhead}
\subsection{Provenance Query and Space}
