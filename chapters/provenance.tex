...
Specifically for Smallbank, we implement the \texttt{ProvHelper} to capture the monetary flow as the state dependency, as attached in Appendix~\ref{ch:append:contracts:smallbank_prov}.
...
The provenance-provided utility is abundant. In the Smallbank contract, we additionally encode a provenance-dependent method \texttt{ConditionalRefund}, as attached in Appendix~\ref{ch:append:contracts:cond_refund}.
