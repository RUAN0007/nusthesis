...
serializability.
%
We evaluate the impact of concurrency control in Fabric on the setup described in \Cref{sec:txn:experiment}.
%
...
%
In \Cref{chart:txn:intro}, a bar reports the raw throughput, while its blue part reports the effective throughput. 
%
