...
%
For better clarity, Chapter~\ref{sec:txn:background} goes through an example in EOV architecture. 
...
But we perform an additional experiment to differentiate the intervention from data provenance, as explained in Chapter~\ref{sec:txn:impl:intervention}. 
