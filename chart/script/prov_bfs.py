...
def main():
    ...
    series[config.kFabricPlusLabel] =  [x / base for x in [30973, 65782, 146790, 340255, 621393, 917434]]
    series[config.kFabricSharpLabel] =  [x / base for x in [10079, 14037, 24466, 63795, 123161, 169151]]
