...
def main():
    ...
    series = {}
    series[config.kFabricPlusLabel] = [x / 1000000.0 for x in [41559, 33669, 42458, 31646, 31574]]
    series[config.kFabricSharpLiteLabel] = [x / 1000000.0 for x in [55509, 58855, 57440, 59480, 62494]]
    series[config.kFabricSharpLabel] = [x / 1000000.0 for x in [24201, 24789, 24216, 22860, 25084]]
