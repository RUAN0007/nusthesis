...
def main():
    ...
    data_path = os.path.join(curDir, "data", "provenance", "ycsb_recordsize_storage")
    ...
    record_sizes = x_axis
    xlabels = [x for x in record_sizes]
    ...
    ax.set(xlabel=r'Record Size (Byte)', ylabel='MB')
    ...
    f.legend(handles, labels,
             loc='upper center', ncol=1, bbox_to_anchor=(0.40, 0.90), 
