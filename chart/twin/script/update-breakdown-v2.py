...
#     print path
    ...
    latency_ax.bar(fabric_xticks, fabric_consensus, width=width, color="yellow", edgecolor='black', hatch=fabric_hatch, label="Order", bottom=bottom)
