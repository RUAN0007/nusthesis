...
# thruput = {kFabricLabel: 416, kQuorumLabel: 245, kCockDBLabel: 2443, 
        #    kTiDBLabel: 3650, kEtcdLabel:16781, kTikvLabel:14117}

# thruput = {kFabricLabel: 8637, kQuorumLabel: 19166, kCockDBLabel: 34306, 
#            kTiDBLabel: 71920, kEtcdLabel:282192, kTikvLabel:94050}

thruput = {kFabricLabel: 808, kQuorumLabel: 485, kCockDBLabel: 17136, kTiDBLabel: 8644, kEtcdLabel:39547, kTikvLabel:23360}
...
def main():
    ...
    update_ax.set_title("Mixed Throughput")
    ...
    update_ax.set_ylim([100, 1000000])
